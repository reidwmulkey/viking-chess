...
function onMouseUp(event){
	...
	if(selectedPiece){
		...
		if(square && square.type === "marker" && ((selectedPiece.color === "white" && isBlacksTurn === false) || (selectedPiece.color === "black" && isBlacksTurn === true))){
			board[x][y] = {x: x, y: y, color: selectedPiece.color, type: "piece", isKing: selectedPiece.isKing};
			board[selectedPiece.x][selectedPiece.y] = null;
			determineCaptures(board[x][y]);
